...
INSERT INTO cms_empresa (id_empresa, email, nombre, telefono, logo, foto_cabecera, foto_fondo, direccion) VALUES
(1, 'empresa@ejemplo.com', 'Netflis', 963452313, 'logo.png', 'header.jpg', 'fondo.jpg','C/Falsa 123');

INSERT INTO cms_categoria (id_categoria_padre, id_categoria, nombre, id_empresa) VALUES
(0, 0, 'ninguna', 1),
(0, 1, 'peliculas', 1),
(0, 2, 'series', 1),
(1, 3, 'super-heroes',1),
...
INSERT INTO cms_articulo (id_articulo, nombre, descripcion, foto, id_categoria) VALUES
...
INSERT INTO cms_foto (id_foto, foto, descripcion, id_articulo) VALUES
...
INSERT INTO cms_links (id_link, texto, vinculo, id_articulo) VALUES
...
INSERT INTO cms_tipo_usuario (id_tipo, tipo_usuario) VALUES
(1, 'administrador'),
(2, 'usuario');

INSERT INTO cms_usuarios (id_usuario, nombre, apellido, email, telefono, direccion, contraseña, id_tipo, id_empresa) VALUES
('pepito24', 'Pepe', 'Garcia Garcia', 'pepe123@gmail.com', 964585296, 'C/De Mentira 555', '12345', 1, 1),
('ivan27', 'Ivan', 'Cordoba Donet', 'ivan27@gmail.com', 963485214, 'Av Sin Nombre 111','12345', 2, 1);