		...
		if(isset($_REQUEST['enviar'])){
			...
			if (is_uploaded_file ($_FILES['foto']['tmp_name'])){
				...
				if ($result=mysqli_query($link, $cond)){
					header( "Location: fotos.php?id_articulo=$id_articulo");
				}
				else{
					echo "<div class='formulario_inicio_sesion'>";
						echo "Fallo al insertar el registro<br>";
						echo "<a href='anadir_foto.php?id_articulo=$id_articulo'>ATRAS</a>";
					echo "</div>";
				}
			}
		}
			...
			echo "<div class='seccion_fotos_formulario'>";
				echo "<div class='foto_formulario23'>";
					echo "<form action='anadir_foto.php' method='POST' enctype='multipart/form-data'>";
