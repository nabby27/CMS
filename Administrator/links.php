			...
			elseif(isset($_REQUEST['id_link'])){
				...
				echo "<nav>";
					echo "<ul>";
						...
						echo "<li><a href='add_links.php?id_article=$id_article'>AÑADIR</a></li>";
					echo "</ul>";
				echo "</nav>";
					...
					while($row = mysqli_fetch_assoc($result)){
						echo "<div class='picture_form23'>";
							echo "<form action='links.php?id_article=$id_article' method='POST' enctype='multipart/form-data'>";
								echo "Nombre a mostrar:<br><br><input type='text' name='name' size='30' value='".$row['name']."'><br><br>";
								...
								echo "</select><br><br>";
								echo "<input type='submit' name='send' value='Guardar cambios'><br><br>";
